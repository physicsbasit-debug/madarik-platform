    ...
    <div className="platform-dashboard">
      <section className="platform-dashboard-hero">
        <div className="platform-dashboard-hero-copy">
          ...
          <h1>من المصدر إلى الاختبار في مساحة عمل واحدة</h1>
          <p>
            اجمع المصادر، عالج أوراق الاختبارات، راجع الترجمة، واربط
            الأسئلة بالمنهج قبل تحويلها إلى اختبارات وأنشطة ورسوم جاهزة.
          </p>
      ...
      <section className="platform-dashboard-section">
        <div className="platform-dashboard-section-heading">
          ...
          <p>
            تعمل جميع الوحدات على بيانات المشروع نفسها، مع انتقال مباشر بين
            المصادر والمراجعة والإنتاج دون تكرار الملفات.
          </p>
        </div>
      ...
      <section className="platform-workflow-overview">
        <div className="platform-workflow-overview-copy">
          ...
          <p>
            تعمل معالجة الورقة داخل مسار واضح ومتكامل مع بقية وحدات المنصة،
            من الاستيراد والتحليل إلى الاعتماد والتصدير.
          </p>
        </div>
        <ol>
          <li>
